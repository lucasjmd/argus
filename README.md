...
<br>
Argus is a technical sandbox which allows me to experiment with building high-throughput data pipelines.
...
(e.g. decoupling logic from data source) and performance benchmarking.<br>

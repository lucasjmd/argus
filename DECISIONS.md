...
extremely fast which prepares us for high-volumes of financial transactions passing through.<br><br>
...
The simulated data we are using is large enough to cause performance issues. It keeps the momory footprint constant (`O(1)`).<br><br>
